...
export targetwrfchemdir=$iprwrf415s1

# met em data
export metdir=/gpfs/home/hpc15zha/project/11_wrfchem_20211129/output/EmisUpdate_1/LongTermSim/2017/met_embackup/

# declare log directory
export logdir=/gpfs/home/hpc15zha/project/11_wrfchem_20211129/output/EmisUpdate_1/LongTermSim_415/2017/00_autoRunScript/wrfrun/logdir_201707
mkdir -p $logdir

# declare namelist
export namelistdir=/gpfs/home/hpc15zha/project/11_wrfchem_20211129/output/EmisUpdate_1/LongTermSim_415/2017/00_autoRunScript/wrfrun/namelistdir_201707
...
# camchem dir
export camchemdir=/gpfs/home/hpc15zha/scratch/wrfchem/camchem/201707_LargeChina
...
#==== no Need this section, This is for IRR, echo all to wrfchem_irr_diag_d01 =============
